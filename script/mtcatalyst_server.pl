...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{MTCATALYST_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{MTCATALYST_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
mtcatalyst_server.pl - Catalyst Testserver

=head1 SYNOPSIS

mtcatalyst_server.pl [options]
